...
def convert_dataset(db:pgDB, query, experiment_type='training'):
            ...
            try:
                if os.path.isfile(pPATH_rsd):
                    ...
                    mol_residues = select_residue(mol_ligand, pPATH_pck,
                                                  save_path=f'D:/Data/PDBbind/preprocessed/HD011-{experiment_type}/residues')
            except:
                pass
    ...
    with tqdm(total=len(result)) as pbar2:
        ...
        exstGrph = os.listdir(f'D:/Data/PDBbind/preprocessed/HD011-{experiment_type}/graph/')
        ...
        for id, lig, rsd in zip(pdb_code_list, mol_ligand_list, mol_residues_list):
            ...
            save_path = f'D:/Data/PDBbind/preprocessed/HD011-{experiment_type}/graph'
...
if __name__ == '__main__':
    ...
    convert_dataset(db, query_coreset, experiment_type='ex_test')